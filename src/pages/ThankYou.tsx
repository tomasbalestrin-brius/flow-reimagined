      ...
      <div className="w-full max-w-xl mx-auto px-5 md:px-8 pb-12">
        <div className="text-center space-y-6">
          ...
          <div className="bg-white bg-opacity-5 border border-white border-opacity-20 rounded-lg p-6 space-y-3">
            <p className="text-sm md:text-base text-gray-300">Sua call está agendada para:</p>
            <p className="text-xl md:text-2xl font-bold text-white capitalize">
              {formatDateLong(selectedDate)}
            </p>
            <p className="text-2xl md:text-3xl font-bold" style={{ color: '#5D99F8' }}>
          ...
          <Button
            onClick={() => window.location.href = 'https://lp.bethelescoladenegocios.com.br/bethel-educacao-pag-ot-v1-h1'}
            className="mt-8 px-8 py-6 text-lg font-poppins font-semibold rounded-lg"
